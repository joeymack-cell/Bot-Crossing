 ...
 * lookAt on the CPU.
 */
export function createLabel(text, accent, pixelRatio = 4, sign = false) {
  const fontSize = 34
  ...
  if (sign) {
    c.fillStyle = '#181e29'
    c.beginPath(); c.roundRect(1, 1, w - 2, h - 2, 10); c.fill()
    c.strokeStyle = '#' + new THREE.Color(accent).getHexString()
